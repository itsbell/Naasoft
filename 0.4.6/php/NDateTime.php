...
class NDateTime
{
    ...
    {
        $this->year = $json->_year;
        $this->month = $json->_month;
        $this->day = $json->_day;
        $this->date = $json->_date;
        $this->dayOfWeek = $json->_dayOfWeek;
        $this->hour = $json->_hour;
        $this->minute = $json->_minute;
        $this->sec = $json->_sec;
        $this->time = $json->_time;
    }
}
