...
export class AtticForm extends CompositeWindow {
    ...
    async OnSignOutButtonClicked() {
        ...
        // // 로그인 이후에 추가된 풀이들을 찾는다.
        // // 로그인 이후에 추가된 질문들을 찾는다.
        // const playShelf = PlayShelf.GetInstance();
        // const nowShelf = playShelf.GetSolutionsAndQuestionsUntilNow(time);
        // // 서버에 데이터 저장을 요청한다.
        // // const requestor = new PhpRequestor();
        // const jsonString = JSON.stringify(nowShelf);
        // console.log(jsonString);
        // // await requestor.Post("../php/SaveUntilNow.php", "now=" + jsonString);
