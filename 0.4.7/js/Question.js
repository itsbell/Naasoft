...
export class QuestionBook extends BusinessObjects {
    ...
    GetIntegrateObject(time) {
        const integrateBook = new QuestionBook();
        ...
        while (i < this._length) {
            questionList = this._objects[i];
            integrateList = questionList.GetIntegrateObject(time);
...
export class QuestionList extends BusinessObjects {
    ...
    GetIntegrateObject(time) {
        const integrateList = new QuestionList(this._problem, this._solution);
